                ...
                <div className='modal-box rounded-lg border border-accent space-y-5'>
                                        ...
                                        <div className='flex flex-row gap-1 items-center'>
                                            <div className={`flex flex-row items-center gap-2 pr-2 ${isMyComment ? ("bg-gradient-to-r from-sky-950 to bg-indigo-950") : ("bg-secondary")} w-fit pr-2 rounded-full`}>
                                                ...
                                                <div className='flex gap-2 items-center'>
                                                    ...
                                                    <Link className="hover:underline underline-offset-2 text-primary text-sm" viewTransition to={`/profile/${comment?.by.username}`}>
                                                        @{comment?.by.username}
                                                    </Link>
                                                    <span className="text-lg opacity-50">|</span>
                                                    <span className="flex text-sm flex-row gap-0.5 items-center">
                                            ...
                                            {isMyComment &&
                                                <button
                                                    ...
                                                    className='ml-auto cursor-pointer hover:text-red-400 transition-colors duration-300 hover:scale-110'
                                                    onClick={() => {
                    ...
                    >
                        ...
                        <button
                            ...
                            disabled={isCommenting || !comment || comment.trim().length === 0}
                        >
                            {isCommenting ?
